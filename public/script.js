...
// button components for better Ux {
    function AddBtn() {
      ...
      <div class='side-nav'>
        ...
        <div class='final'>
          <strong>Total: R <span class='total'>0</span>.00/-</strong>
          <div class='action'>
      ...
      function Purchase() {
        ...
        let itemPrices = cartDetails.map(item => {
          return `<span>R ${item.price * item.qty}</span>`;
        });
        return `
      <div class='invoice'>
      ...
      <hr>
        <div class='payment'>
          <em>payment</em>
          <div>
            <p>total amount to be paid:</p><span class='pay'>R ${toPay}</span>
          </div>
        </div>
        <div class='order'>
      ...
      <div>
        <div class='order-details'>
          ...
          <p>you can pay <span>R ${totalCost}</span> by card or any online transaction method after the products have been dilivered to you</p>
        </div>
